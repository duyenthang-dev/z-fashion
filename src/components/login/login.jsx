    ...
    return (
        ...
        <div className="Login_compo">
            ...
            <div className="logo_zf">
                 <img  src={logo_img} alt="z_fashion" width="628px" height="320px" />
            </div>
                 ...
                 <div className="login_page">
                     <div className="Login_frame">
                        ...
                        <div className="login_box">
                            <input className="username" type="text" placeholder="    Email/Số điện thoại/User name"/>
                            <br/>
                        ...
                        <div className="lostpass">
                         <a className="lostpasstext" href="">Quên mật khẩu</a>
                        </div>
                    ...
                    <hr />
                     <div className="Another_way_to_login">
                        ...
                        <a className="fb_link" href="" target="_blank" >
                             <img src={fb_logo} alt="facebook" border="0" width="150px" height="29.1px" />
                        </a>

                        <a  className="gg_link" href="" target="_blank">
                            <img src={gg_logo} alt="google" border="0"width="150px" height="50px" />
                        </a>
                    ...
                    <div    className="SignUp">
                        ...
                        <a  className="signuplink" href="">Đăng ký</a>
                    </div>
